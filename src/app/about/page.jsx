      ...
      <div className="  py-12 mx-auto ">
        <div className=" mx-auto flex  py-16 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col items-start md:text-left mb-16 md:mb-0">
            ...
            <p className="mb-4 sm:text-xl text-lg   text-gray-600">
            ...
            <i className="mb-4 sm:text-xl text-lg   text-gray-600">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {AboutData.map((item, index) => (
            <div key={index} className="p-6 border bg-gray-100 rounded-lg">
              <h2 className="sm:text-2xl text-xl  mb-3 font-bold uppercase text-gray-600 ">
                {item.college}
              </h2>
              <p className=" sm:text-xl text-lg   text-gray-600 mb-2">
                {item.branch}
              </p>
              <p className="  mb-2 sm:text-xl text-lg   text-gray-600">
                {" "}
                {item.year}
              </p>
