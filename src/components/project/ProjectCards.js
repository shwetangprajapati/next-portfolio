                ...
                <div className="container mx-auto">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {Projects.map((item, index) => (
                            ...
                            >
                                <h2 className="sm:text-2xl text-xl font-bold  text-gray-600 mb-3 uppercase">
                                    {item.name}
                                </h2>
                                <p className="leading-relaxed mb-3 line-clamp-4 sm:text-xl text-lg   text-gray-600">
                                    {item.desc}
                                </p>
                                <div className="tracking-widest text-xs title-font  font-medium text-gray-600 mb-1">
